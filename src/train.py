...
def train(config: dict) -> None:
    ...
    # Metrics logger
    logger = MetricsLogger(str(reports_dir / 'metrics'),
    ...
    plot_training_curves(history, str(
        reports_dir / 'figures' / 'training_curves.png'))
...
def main():
    ...
    if args.quick_test:
        ...
        config['data']['max_samples_per_class'] = 100
