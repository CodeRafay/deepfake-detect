...
def create_data_loaders(train_dir: str,
    ...
    train_dataset = DeepfakeDataset(train_dir, train_transform, max_samples_per_class)
    test_dataset = DeepfakeDataset(test_dir, test_transform, max_samples_per_class)
